...
void CommandManager::transitionImage(VkImage image, VkImageLayout srcLayout, VkImageLayout dstLayout) const {
...
void CommandManager::submit(VkQueue queue, VkSemaphore waitSemaphore, VkSemaphore signalSemaphore,
                            VkFence signalFence) {
